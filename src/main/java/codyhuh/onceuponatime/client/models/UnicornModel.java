...
public class UnicornModel<T extends Unicorn> extends AgeableListModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(28, 11).addBox(-2.5F, -5.0F, -4.0F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(30, 0).addBox(-3.0F, -9.0F, -5.0F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(40, 46).addBox(-2.5F, -9.0F, -9.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, -5.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(43, 55).addBox(0.0F, 0.0F, -2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -7.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(47, 55).addBox(0.0F, 0.0F, -2.0F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -7.0F, 0.0F, 0.0F, 0.3491F));

		PartDefinition horn = head.addOrReplaceChild("horn", CubeListBuilder.create(), PartPose.offset(0.0F, -9.0F, -3.0F));
		...
		PartDefinition mane = head.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(0, 31).addBox(-1.0F, -10.0F, -5.0F, 2.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 3.0F));

		PartDefinition l_ear = head.addOrReplaceChild("l_ear", CubeListBuilder.create().texOffs(5, 70).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -9.0F, -2.0F));

		PartDefinition r_ear = head.addOrReplaceChild("r_ear", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -9.0F, -2.0F));
