package codyhuh.onceuponatime.util;
...
public class OUATMath {
    ...
    public static float sampleNoise2D(int x, int z, float simplexSampleRate) {
        return (float) ((SimplexNoise.noise((x + simplexSampleRate) / simplexSampleRate, (z + simplexSampleRate) / simplexSampleRate)));
    }
