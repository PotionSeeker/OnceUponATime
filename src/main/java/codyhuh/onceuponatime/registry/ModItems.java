...
public class ModItems {
    ...
    public static final RegistryObject<Item> HYDRA_SPAWN_EGG = ITEMS.register("hydra_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.HYDRA, 0x24693d, 0xe6e73c, new Item.Properties()));
