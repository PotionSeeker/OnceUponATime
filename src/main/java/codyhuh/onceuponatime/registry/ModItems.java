...
public class ModItems {
    ...
    public static final RegistryObject<Item> GRIFFIN_SPAWN_EGG = ITEMS.register("griffin_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.GRIFFIN, 0x643c23, 0xdad7cf, new Item.Properties()));
}
